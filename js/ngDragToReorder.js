        ...
        .directive('dtrDraggable', ['ngDragToReorder', '$parse', function(ngDragToReorder, $parse) {
            return {
                ...
                link: function(scope, element, attrs, ctrls) {
                    ...
                    var el = element[0],
                        list, stringIdx, int, item, listCtrl = ctrls[0] ? ctrls[0] : ctrls[1],
                        newIdx, prevIdx, target, offsetY, dragging = 'dtr-dragging',
                        over = 'dtr-over',
                        droppingAbove = 'dtr-dropping-above',
                        droppingBelow = 'dtr-dropping-below',
                        transition = 'dtr-transition',
                        eventName = 'dropped',
                        delay = 1000,
                        loaded = false,
                        above = [],
                        ...
                        topOffset = 50,
                        bottomOffset = 50,
                        windowHeight, listHeight, slowScroll = false,
                        fastScroll = false,
                        listScrollbar = false,
                        listEl, listScroll = false,
                        itemOffestTop, startY, listTopY,
